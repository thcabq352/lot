...
pub fn help_spec() -> Value {
    json!({
        ...
        "door": ["cli", "mcp"],
        "school_default": "off",
        "notice": "Flags only. No TTY prompts. Exit 0 = ok. Do not click folder dialogs. --cap / LOT_CAP / MCP cap: read|write|render|export|spend (unset = all).",
        "verbs": [
            ...
            verb("lot breakdown import --file", "lot_breakdown_import", "breakdown", "Import .txt / .fountain / .scriptbreak. Does not delete the source."),
